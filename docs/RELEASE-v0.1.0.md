# mgbrowser v0.1.0 Experimental Preview

<img src="https://mgbrowser.org/assets/mgbrowser.svg" width="96" alt="Burning magnesium Mg tile">

A browser written from the ground up in Rust. This first downloadable preview
...
These are intentional preview limitations, not a completed formal MVP. The
engine cutoff is `4b9a5f74b09f4e3092f26d5c61d6b8a04e22a4da`; release work adds
packaging, startup help and distribution without another compatibility iteration.
