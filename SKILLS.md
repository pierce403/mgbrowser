...
Agents automatically select matching skills from this catalog; open the file before using it. Explicit naming is not required. This portable mechanism works through AGENTS.md and does not depend on a particular agent's private skill installation.
