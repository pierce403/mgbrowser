...
pub fn execute(
    _: mg_sparkle::js_browser::Request,
) -> Result<mg_sparkle::js_browser::Reply, String> {
...
mod linux {
    ...
    #[cfg(test)]
    use super::isolation::filter;
    pub(super) use super::isolation::install_isolation;
